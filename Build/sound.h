...
enum 
{
	...
	SOUND_LABEL_SE_misairu000,		// 
	SOUND_LABEL_SE_misairu001,		// 
	SOUND_LABEL_SE_alert001,		// 
	SOUND_LABEL_SE_bomb001,		// 

	SOUND_LABEL_BGM_maou,		// BGM Maou
	SOUND_LABEL_BGM_maou1,		// BGM Maou
	SOUND_LABEL_BGM_maou2,		// BGM Maou
